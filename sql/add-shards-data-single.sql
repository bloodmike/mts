--
-- Первичное наполнение схемы данными при условии, что всё лежит на одном хосте
--
INSERT INTO `users_shards`
    SET `from_user_id` = 1, `to_user_id` = 1000000, `host_id` = 1, `type` = 1;

INSERT INTO `orders_digest_shards`
    SET `from_ts` = 0, `to_ts` = 1893369600, `from_hash` = '', `to_hash` = 'zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz', `host_id` = 1;

INSERT INTO `users_logins_shards`
    SET `from_login` = '', `to_login` = 'zzzzzzzzzzzzzzzzzzzzzzzzz', `host_id` = 1, `type` = 1;

--
-- Добавляем пользователя 1 и информацию о расположении его данных
--
INSERT INTO `users`
...
INSERT INTO `users_orders_shards`
    SET `user_id` = 1, `from_order_id` = 1, `host_id` = 1;

INSERT INTO `finished_orders_shards`
    SET `finished_user_id` = 1, `from_finished_ts` = 0, `host_id` = 1;

--
-- Добавляем пользователя 2 и информацию о расположении его данных
--
INSERT INTO `users`
...
INSERT INTO `users_orders_shards`
    SET `user_id` = 2, `from_order_id` = 1, `host_id` = 1;

INSERT INTO `finished_orders_shards`
    SET `finished_user_id` = 2, `from_finished_ts` = 0, `host_id` = 1;

--
-- Добавляем пользователя 3 и информацию о расположении его данных
--
INSERT INTO `users`
